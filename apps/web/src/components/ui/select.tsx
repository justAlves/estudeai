...
function SelectTrigger({
  ...
  return (
    <div className="relative w-full group">
      <div className="absolute -inset-[1px] rounded-md bg-gradient-to-r from-green-500 to-emerald-600 opacity-0 group-data-[state=open]:opacity-100 transition-opacity duration-200 pointer-events-none" />
